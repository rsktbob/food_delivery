...
urlpatterns = [
    ...
    path('api/cart/<int:cart_item_id>/delete', views.delete_cart_items),
    path('api/cart/<int:cart_item_id>/update', views.update_cart_item_quantity),
    path('api/orders/<int:order_id>/status/', views.set_order_status),
